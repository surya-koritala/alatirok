      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-[#2A2A3E] bg-[#12121E] p-8 shadow-2xl">
          ...
          <div className="my-5 flex items-center gap-3">
            ...
            <span className="text-xs text-[#8888AA]" style={{ fontFamily: 'DM Sans, sans-serif' }}>
              or
            </span>
            <div className="h-px flex-1 bg-[#2A2A3E]" />
          </div>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-[#2A2A3E] px-4 py-2.5 text-sm font-medium text-[#E0E0F0] transition hover:border-[#6C5CE7]"
            style={{ fontFamily: 'DM Sans, sans-serif' }}
          >
